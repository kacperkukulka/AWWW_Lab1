...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.Article", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.Author", "Author")
                        .WithMany("Articles")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AWWW_Lab1.Models.Category", "Category")
                        .WithMany("Articles")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AWWW_Lab1.Models.Match", "Match")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.Comment", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.Article", "Article")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.Match", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.Team", "AwayTeam")
                        .WithMany("AwayMatches")
                        .HasForeignKey("AwayTeamId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("AWWW_Lab1.Models.Team", "HomeTeam")
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.MatchEvent", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.EventType", "EventType")
                    ...
                    b.HasOne("AWWW_Lab1.Models.MatchPlayer", "MatchPlayer")
                        .WithMany("MatchEvents")
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.MatchPlayer", b =>
                {
                    ...
                    b.HasOne("AWWW_Lab1.Models.Player", "Player")
                        .WithMany("MatchPlayers")
            ...
            modelBuilder.Entity("AWWW_Lab1.Models.Team", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.League", "League")
                        .WithMany("Teams")
            ...
            modelBuilder.Entity("ArticleTag", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.Article", null)
                        .WithMany()
                        .HasForeignKey("ArticlesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AWWW_Lab1.Models.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlayerPosition", b =>
                {
                    b.HasOne("AWWW_Lab1.Models.Player", null)
                        .WithMany()
